module TestState exposing (TestState, advanceTime, drain, queueEffect, routeChangeHelper, simulateLoadUrlHelper, toHistory, update, withSimulation)
...
toHistory : TestState model msg effect -> List model
toHistory state =
    state.currentModel :: state.history
